...
/** \file
 * \defgroup BVTOrientation BVTOrientation Object
...
/** Opaque type for the BVTOrientation object */
 ...
 */
BVTSDK_EXPORT RetVal BVTOrientation_SetData(BVTOrientation obj, int source, int target, double X_axis_degrees, double Y_axis_degrees, double Z_axis_degrees, double X_axis_offset, double Y_axis_offset, double Z_axis_offset);
 ...
 */
BVTSDK_EXPORT RetVal BVTOrientation_GetData(BVTOrientation obj, int* source, int* target, double* X_axis_degrees, double* Y_axis_degrees, double* Z_axis_degrees, double* X_axis_offset, double* Y_axis_offset, double* Z_axis_offset);
 ...
 */
BVTSDK_EXPORT RetVal BVTOrientation_SetPanTiltCalibrationData(BVTOrientation obj, int head_orientation, int x_raw_direction, int x_axis_affected, int x_axis_direction, int y_raw_direction, int y_axis_affected, int y_axis_direction, int z_raw_direction, int z_axis_affected, int z_axis_direction);
 ...
 * \param z_axis_direction one of the OR_ROTATIONDIRECTION_* constants 
 */
BVTSDK_EXPORT RetVal BVTOrientation_GetPanTiltCalibrationData(BVTOrientation obj, int* head_orientation, int* x_raw_direction, int* x_axis_affected, int* x_axis_direction, int* y_raw_direction, int* y_axis_affected, int* y_axis_direction, int* z_raw_direction, int* z_axis_affected, int* z_axis_direction);
 ...
 * \param obj Object pointer
 */
BVTSDK_EXPORT double BVTOrientation_GetTimestamp(BVTOrientation obj);

/** Set the time stamp.  
 * \param obj Object pointer
 * \param sec Timestamp in seconds since 00:00:00 UTC, January 1, 1970 
 */
BVTSDK_EXPORT RetVal BVTOrientation_SetTimestamp(BVTOrientation obj, double sec);
